...
_NIVEL_POR_EJERCICIO = {
    ...
    "schultz_jacobson": 1, "pendulo_cervical": 1,
    "b_prolongada": 2, "masaje_aronson": 1, "traccion_laringea": 2,
    "soplo_fraccionado": 1, "respiracion_dinamica": 2,
    "automatismos_lenguaje": 4, "metodo_acento": 2,
    "tubo_aire_libre": 2, "fricativas_sonoras": 2, "trino_labial": 2,
    "trino_lingual": 2, "mano_boca": 2, "finger_kazoo": 2,
    "vocales_cerradas": 2, "laxvox_agua": 2, "messa_di_voce": 3,
    "apertura_fondo_boca": 1, "moldeado_vertical": 2,
    "masticacion_froeschels": 1, "bostezo_suspiro": 2,
    "sobrearticulacion": 3, "desplazamiento_lingual": 2,
    "efv_stemple": 3, "tvr_verdolini": 3, "voz_confidencial": 1,
    "flow_phonation": 2, "lsvt_fuerte": 3, "pushing_terapeutico": 2,
    "fonacion_inspiratoria": 3, "fry_basal": 1, "falsete_agudos": 3,
    "deglucion_sonorizada": 2,
}
_EFECTO_POR_EJERCICIO = {
    ...
    "schultz_jacobson": "Suelta la tensión de todo el cuerpo",
    "pendulo_cervical": "Libera cuello y entrada de la laringe",
    "b_prolongada": "Firmeza glótica sin golpe",
    "masaje_aronson": "Afloja la tensión profunda del cuello",
    "traccion_laringea": "Equilibra los lados de la laringe",
    "soplo_fraccionado": "Dosifica el aire en tiempos",
    "respiracion_dinamica": "Aire rápido y silencioso al hablar",
    "automatismos_lenguaje": "Habla automática con apoyo",
    "metodo_acento": "Impulso rítmico del aire",
    "tubo_aire_libre": "Resistencia suave en el aire",
    "fricativas_sonoras": "Vibración estable con /v/ /z/",
    "trino_labial": "Masaje de mucosa con /br/",
    "trino_lingual": "Moviliza la mucosa con /rr/",
    "mano_boca": "Presión suave con la mano",
    "finger_kazoo": "Semioclusión con el dedo",
    "vocales_cerradas": "Tracto estrecho con /u/ /i/",
    "laxvox_agua": "Burbujeo que masajea las cuerdas",
    "messa_di_voce": "Control fino del volumen",
    "apertura_fondo_boca": "Boca amplia sin tensión",
    "moldeado_vertical": "Vocales abiertas en secuencia",
    "masticacion_froeschels": "Mandíbula suelta con voz",
    "bostezo_suspiro": "Relajación total con suspiro",
    "sobrearticulacion": "Claridad sin esfuerzo laríngeo",
    "desplazamiento_lingual": "Lengua libre y móvil",
    "efv_stemple": "Calienta, estira y fortalece",
    "tvr_verdolini": "Resonancia fácil paso a paso",
    "voz_confidencial": "Descansa la voz con voz suave",
    "flow_phonation": "Aire continuo sin empujar",
    "lsvt_fuerte": "Reescala el volumen de la voz",
    "pushing_terapeutico": "Cierre firme supervisado",
    "fonacion_inspiratoria": "Desacopla con aire inspirado",
    "fry_basal": "Relaja con registro grave",
    "falsete_agudos": "Estira hacia los agudos",
    "deglucion_sonorizada": "Cierre por ascenso laríngeo",
}
...
_PROPOSITO_SECCION = {
    ...
    "orofaringeo": "Para abrir la boca y mover mejor la lengua al hablar.",
    "metodos": "Programas y maniobras especiales, siempre con supervisión.",
}
